...
more details into each update can be found on [github](https://github.com/clairefreehafer/webbed-site-nextjs/commits/main/).

### 2025-12-09

- created sauces recipe section
- updated some lists
- added a recipe

### 2025-12-04

- added and updated a bunch of lists
- added a meal recipe

### 2025-09-12

- added [see no evil](/recipes/cocktails/see-no-evil) cocktail recipe
...
- added bare-bones [new leaf](/animal-crossing/new-leaf) album
