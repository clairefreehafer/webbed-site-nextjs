export const title = "garlic butter rice";
export const sourceUrl = "https://craveitall.com/garlic-butter-rice/";
export const ingredients = ["rice"];

#### ingredients

- 4 tablespoons butter, divided
- 5 cloves garlic, minced
- 1 ½ cups uncooked white rice, long gran, basmati or jasmine
