export const title = "balsamic tomato parmesan risotto";
export const sourceUrl =
  "https://www.hellofresh.com/recipes/balsamic-tomato-parmesan-risotto-60197068ff98cf54561ab41f";
export const ingredients = ["risotto", "scallion", "zucchini", "tomato"];
