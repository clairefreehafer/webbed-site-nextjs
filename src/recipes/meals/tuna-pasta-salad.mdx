export const title = "tuna pasta salad";
export const sourceUrl = "https://www.acouplecooks.com/tuna-pasta-salad/";
export const ingredients = ["pasta", "onion", "scallion", "tuna"];
