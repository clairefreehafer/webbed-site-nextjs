export const title = "sweet pickle potato salad";
export const sourceUrl =
  "https://archive.is/2023.02.06-034835/https://www.epicurious.com/recipes/food/views/sweet-pickle-potato-salad";
export const ingredients = ["egg", "potato", "scallion"];
