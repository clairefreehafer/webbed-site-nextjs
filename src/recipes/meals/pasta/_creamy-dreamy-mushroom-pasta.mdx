export const title = "creamy dreamy mushroom pasta";
export const sourceUrl =
  "https://www.hellofresh.com/recipes/chicken-and-mushroom-cavatappi-6759ebcadaedc2bd1295ae2c";
export const ingredients = ["pasta", "mushroom", "scallion"];
